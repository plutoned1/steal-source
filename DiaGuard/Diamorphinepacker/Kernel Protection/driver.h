...
typedef enum _SYSTEM_INFORMATION_CLASS1 {
	SystemBasicInformation1 = 0,
	SystemPerformanceInformation1 = 2,
	SystemTimeOfDayInformation1 = 3,
	SystemProcessInformation1 = 5,
	SystemProcessorPerformanceInformation1 = 8,
	SystemInterruptInformation1 = 23,
	SystemExceptionInformation1 = 33,
	SystemRegistryQuotaInformation1 = 37,
	SystemLookasideInformation1 = 45,
	SystemCodeIntegrityInformation1 = 103,
	SystemPolicyInformation1 = 134,
} SYSTEM_INFORMATION_CLASS1;

typedef enum _OBJECT_INFORMATION_CLASS1 {
	ObjectBasicInformation1 = 0,
	ObjectTypeInformation1 = 2
} OBJECT_INFORMATION_CLASS1;

typedef NTSTATUS(*tNtQuerySystemInformation)(SYSTEM_INFORMATION_CLASS1 SystemInformationClass, PVOID SystemInformation, ULONG SystemInformationLength, PULONG ReturnLength);
typedef NTSTATUS(*tNtQueryObject)(HANDLE Handle, OBJECT_INFORMATION_CLASS1 ObjectInformationClass, PVOID ObjectInformation, ULONG ObjectInformationLength, PULONG ReturnLength);
